                ...
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-offset-1 col-xs-10">
                    <div class="error-container">
                        <div class="error-main">
                            ...
                            <br>
                            <router-link to="/" tag="button" class="btn btn-primary btn-cons" >Go Home</router-link>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="footer">
            <div class="error-container">
                <ul class="footer-links">
                    <li><a href="#">System Guidelines</a></li>
                ...
                <br>
                <div class="copyright"> &copy; Carnegie Mellon University - Africa, 2019 </div>
            </div>
        </div>
    </div>
</template>
