            ...
            <div class="header-seperation">
                ...
                <ul class="nav pull-right notifcation-center">
                    <li class="dropdown hidden-xs hidden-sm">
                        <router-link to="/" class="dropdown-toggle active">
                ...
                <div class="pull-right">
                    <div class="chat-toggler sm">
                        <div class="profile-pic">
                            <img src="assets/img/profiles/avatar.png" alt="" data-src="assets/img/profiles/avatar.png"
                                 data-src-retina="assets/img/profiles/avatar.png" width="35" height="35"/>
                        ...
                        <li class="quicklinks">
                            ...
                            <ul class="dropdown-menu  pull-right" role="menu" aria-labelledby="user-options">
                                ...
                                <li v-if="auth">
                                    ...
                                    <a href="#" @click.prevent="onLogout"><i class="material-icons">power_settings_new</i>
                                        Log out</a>
                                </li>
                            </ul>
                        </li>
